        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-4 mb-4">
                    ...
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 sm:max-w-md">
                            <input type="text" inputmode="tel" name="telepon" id="telepon" autocomplete="telepon" class="block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset @error('telepon') ring-red-600 @else ring-gray-300 @enderror placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6" placeholder="0812********" value="{{ old('telepon') }}">
                        </div>
                        @error('telepon')
                            <p class="mt-2 text-sm leading-6 text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="col-span-full mb-4">
                    ...
                    <div class="mt-2">
                        <textarea id="ulasan" name="ulasan" rows="3" class="block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset @error('ulasan') ring-red-600 @else ring-gray-300 @enderror placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6">{{ old('ulasan') }}</textarea>
                        @error('ulasan')
                            <p class="mt-2 text-sm leading-6 text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
